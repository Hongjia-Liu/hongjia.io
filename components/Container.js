	...
	return (
		<Link href={href}>
			<a
				className={
					isActive
						? "hidden rounded-lg p-1 font-semibold text-gray-800 transition-all hover:bg-gray-200 dark:text-gray-200 dark:hover:bg-gray-800 sm:px-3 sm:py-2 md:inline-block"
						: "hidden rounded-lg p-1 font-normal text-gray-600 transition-all hover:bg-gray-200 dark:text-gray-400 dark:hover:bg-gray-800 sm:px-3 sm:py-2 md:inline-block"
				}
			>
